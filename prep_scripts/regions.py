...
def rekey_by_region(data_folder, temp_folder, region_centers):
    ...
    for path in pathlist:
        ...
        regions.append(region_heirarchy)
    ...
    utilities.write_to_csv_file('availible_regions.csv', regions)
    generate_json_hierarchy('availible_regions.csv', REGIONS_JSON_FILE)
